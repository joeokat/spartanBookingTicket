...
<div class="term">
  <div class="sectionX">
    ...
    <div><h3>Minimum Age:</h3> The App is designed for users who are 18 years old or older. Users below the age of 18 are not allowed to use the App.</div>

    <div><h3>Privacy and Security:</h3> The App does not collect user's information and usage data, even for VIP members. However, the App cannot be held responsible for any unauthorized access, use, or disclosure of such information.</div>
